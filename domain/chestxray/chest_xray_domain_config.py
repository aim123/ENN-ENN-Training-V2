...
from domain.chestxray.msft.azure_chestxray_utils import ChestXrayConsts


class ChestXrayDomainConfig(NetworkDomainConfig):
    """
    ...
    def generate_default_info_dict(self, extra_config):
        ...
        multitask = extra_config.get("multitask", True)
        if multitask:
            num_tasks = len(consts.DISEASE_LIST)
    ...
    def determine_input_shapes(self, domain_specific_dict):
        ...
        if domain_specific_dict['encoder'] is None:
            ...
            # service.
            input_shapes = [input_size, input_size, None]
