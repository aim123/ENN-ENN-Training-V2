...
class TextSerializationFormat(SerializationFormat):
    ...
    def __init__(self, must_exist=True):
        ...
        super(TextSerializationFormat, self).__init__()
    ...
    def to_object(self, fileobj):
        ...
        # Implementing this would cause an insecure eval() statement to be
        # brought into the code.
        raise NotImplementedError("Text serialization cannot be restored.")
